...
class HotelRecommendRealTimeResource(Resource) :
    ...
    def get(self) :
        ...
        try :
            ...
            query = '''select h.title, r.userId, r.rating
                    from hotel h
        ...
        drop_index_list = myRating['title'].to_list()
        ...
        recomm_hotel_list = similar_hotels_list.groupby('title')['weight'].max().sort_values(ascending= False).head(count)
