...
from resources.benefit import CouponResource, CouponSearchResource, PointAddResource, PointSearchResource, TotalPointResource
...
api.add_resource(CouponResource, '/benefit/coupon/<int:couponId>')
